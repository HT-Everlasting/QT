...
namespace {
struct qt_meta_tag_ZN10dataConfigE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10dataConfigE = QtMocHelpers::stringData(
    "dataConfig"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10dataConfigE[] = {
...
Q_CONSTINIT const QMetaObject dataConfig::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10dataConfigE.offsetsAndSizes,
    qt_meta_data_ZN10dataConfigE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10dataConfigE_t,
        // Q_OBJECT / Q_GADGET
...
{
    auto *_t = static_cast<dataConfig *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *dataConfig::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10dataConfigE.stringdata0))
