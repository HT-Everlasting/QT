...
namespace {
struct qt_meta_tag_ZN6MyCoinE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN6MyCoinE = QtMocHelpers::stringData(
    "MyCoin"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6MyCoinE[] = {
...
Q_CONSTINIT const QMetaObject MyCoin::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6MyCoinE.offsetsAndSizes,
    qt_meta_data_ZN6MyCoinE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6MyCoinE_t,
        // Q_OBJECT / Q_GADGET
...
void *MyCoin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6MyCoinE.stringdata0))
