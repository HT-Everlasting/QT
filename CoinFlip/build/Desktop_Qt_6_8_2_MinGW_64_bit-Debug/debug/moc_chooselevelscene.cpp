...
namespace {
struct qt_meta_tag_ZN16chooselevelsceneE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN16chooselevelsceneE = QtMocHelpers::stringData(
    "chooselevelscene",
    "chooseSceneback",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16chooselevelsceneE[] = {
...
Q_CONSTINIT const QMetaObject chooselevelscene::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16chooselevelsceneE.offsetsAndSizes,
    qt_meta_data_ZN16chooselevelsceneE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16chooselevelsceneE_t,
        // Q_OBJECT / Q_GADGET
...
void chooselevelscene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (chooselevelscene::*)();
            if (_q_method_type _q_method = &chooselevelscene::chooseSceneback; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *chooselevelscene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16chooselevelsceneE.stringdata0))
