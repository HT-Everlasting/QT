...
static constexpr auto qt_meta_stringdata_ZN12MyPushButtonE = QtMocHelpers::stringData(
    "MyPushButton"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12MyPushButtonE[] = {
...
Q_CONSTINIT const QMetaObject MyPushButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12MyPushButtonE.offsetsAndSizes,
    qt_meta_data_ZN12MyPushButtonE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12MyPushButtonE_t,
        // Q_OBJECT / Q_GADGET
...
void *MyPushButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12MyPushButtonE.stringdata0))
