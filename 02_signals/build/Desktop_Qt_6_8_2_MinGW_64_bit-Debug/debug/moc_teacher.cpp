...
static constexpr auto qt_meta_stringdata_ZN7teacherE = QtMocHelpers::stringData(
    "teacher",
    "hungry",
    "",
    "foodname"
...
Q_CONSTINIT static const uint qt_meta_data_ZN7teacherE[] = {
...
Q_CONSTINIT const QMetaObject teacher::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7teacherE.offsetsAndSizes,
    qt_meta_data_ZN7teacherE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7teacherE_t,
        // Q_OBJECT / Q_GADGET
...
void teacher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (teacher::*)();
            if (_q_method_type _q_method = &teacher::hungry; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (teacher::*)(QString );
            if (_q_method_type _q_method = &teacher::hungry; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
...
void *teacher::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7teacherE.stringdata0))
